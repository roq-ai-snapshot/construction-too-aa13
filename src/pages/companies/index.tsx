...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'admin.count', 'tool.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('admin', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'admin',
          header: 'Admin',
          accessorKey: 'admin',
          cell: ({ row: { original: record } }: any) => record?._count?.admin,
        }
      : null,
