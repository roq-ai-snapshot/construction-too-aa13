...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'tool.update': { roles: ['owner'], key: 'tool-details-updated', tenantPath: ['company', 'tool'], userPath: [] },
  'tool.delete': { roles: ['owner'], key: 'tool-removed', tenantPath: ['company', 'tool'], userPath: [] },
  'reservation.create': {
    roles: ['owner', 'admin'],
    key: 'new-reservation',
    tenantPath: ['company', 'tool', 'reservation'],
    userPath: [],
  },
  'reservation.delete': {
    roles: ['owner', 'admin'],
  ...
  'reservation.update': {
    roles: ['owner', 'admin'],
    key: 'reservation-status-updated',
    tenantPath: ['company', 'tool', 'reservation'],
    userPath: [],
  },
  'admin.delete': { roles: ['owner'], key: 'admin-deactivated', tenantPath: ['company', 'admin'], userPath: [] },
};
